"""
Django settings for non_super_user_test_100 project.
...
ROOT_URLCONF = 'non_super_user_test_100.urls'
...
WSGI_APPLICATION = 'non_super_user_test_100.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "non-super-user-test Support <support@non-super-user-test-100.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "non_super_user_test_100 API",
    "DESCRIPTION": "API documentation for non_super_user_test_100 App",
    "VERSION": "v1",
}
